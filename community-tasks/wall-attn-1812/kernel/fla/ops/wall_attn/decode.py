...
# Vendored for Ascend NPU (task #1812): autotune space pruned and launches pass
...
from fla.utils import ascend_compile_kwargs, autotune_cache_kwargs, check_shared_mem
